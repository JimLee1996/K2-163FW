...
function sperangelength(val, min, max)
	val = tostring(val)
	min = tonumber(min)
	max = tonumber(max)
...
function checkspecialchar_cn(val)
	return true
end
...
function checkPPPspechar(val)
	return true
end

function checkPPPspechar_cn(val)
	return true
end
...
function ddnsdomain(val)
	return true
end

function ddnscheckspecialchar(val)
	return true
end

function checkWirelessspechar(val)
	return true
end
